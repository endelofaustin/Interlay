...
class NewTestamentViewerApp(App):
    def build(self):
        ...
        self.translated_text_display = TextInput(
            readonly=True,
            size_hint=(1, 0.2),  # Use 20% of the available height
            font_size=24,  # Larger text
            background_color=(0.1, 0.1, 0.1, 1),  # Dark background
            foreground_color=(1, 1, 1, 1)
        )
        ...
        self.translation_input = TextInput(
            ...
            size_hint=(1, 0.15),  # Use 15% of the available height
            font_size=24,  # Larger text
            background_color=(0.2, 0.2, 0.2, 1),  # Dark input field
            foreground_color=(1, 1, 1, 1),
            hint_text_color=(0.7, 0.7, 0.7, 1)
        ...
        bottom_buttons_layout.add_widget(self.save_button)
        bottom_buttons_layout.add_widget(self.translate_button)
        bottom_buttons_layout.add_widget(self.email_button)
