...
class NewTestamentViewerApp(App):
    ...
    def load_greek_text(self, instance):
        ...
        try:
            ...
            logger.info(f"Successfully loaded Greek text for {book} {chapter}:{verse_range}")
    ...
    def save_translation(self, instance):
        ...
        logger.info(f"Saving translation for {book} {chapter}:{verse}")
        ...
        try:
            ...
            self.show_popup("Error", f"An error occurred while saving the translation: {e}")
            logger.exception("An error occurred while saving the translation")
    ...
    def translate_text(self, instance):
        ...
        if not greek_text:
            ...
            logger.warning("Translate attempt without loading Greek text")
            return
        ...
        logger.info(f"Translating text: {greek_text[:50]}...")  # Log the first 50 characters of the text
    ...
    def email_translation(self, instance):
        ...
        if not translation:
            ...
            logger.warning("Email attempt without translation")
            return
...
if __name__ == '__main__':
    logger.info("Starting New Testament Viewer App")
