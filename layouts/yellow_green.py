...
Window.clearcolor = (0.96, 0.96, 0.96, 1)  # Light gray background
...
def build_layout(app_instance):
    ...
    app_instance.greek_text_display = TextInput(
        ...
        background_color=(0.96, 0.96, 0.96, 1),  # Light gray background
    ...
    app_instance.book_spinner = Spinner(
        ...
        size_hint=(1, 0.1),
        background_color=(0.23, 0.35, 0.60, 1),  # Deep blue
    ...
    app_instance.load_button = Button(
        ...
        size_hint=(1, None),
        height=50,
        background_color=(1, 0.65, 0, 1),  # Soft orange
        color=(1, 1, 1, 1),  # White text
        background_normal='',
        background_down='',
        border=(20, 20, 20, 20)
