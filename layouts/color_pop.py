...
Window.clearcolor = (0.98, 0.98, 0.82, 1)  # Light cream background
...
def build_layout(app_instance):
    ...
    app_instance.greek_text_display = TextInput(
        ...
        background_color=(0.98, 0.98, 0.82, 1),  # Light cream background
    ...
    app_instance.book_spinner = Spinner(
        ...
        size_hint=(1, 0.1),
        background_color=(0.32, 0.94, 0.75, 1),  # Vibrant teal
    ...
    app_instance.chapter_input = TextInput(
        ...
        background_color=(0.90, 0.90, 0.90, 1),  # Light gray input field
        foreground_color=(0, 0, 0, 1),  # Black text
    ...
    app_instance.load_button = Button(
        ...
        size_hint=(1, None),
        height=50,
        background_color=(1, 0.65, 0.45, 1),  # Coral color
        color=(1, 1, 1, 1),  # White text
        background_normal='',
        background_down='',
        border=(20, 20, 20, 20)
